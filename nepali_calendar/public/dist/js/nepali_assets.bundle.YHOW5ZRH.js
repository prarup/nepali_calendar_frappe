(() => {
  ...
  // ../nepali_calendar/node_modules/nepali-date-converter/dist/nepali-date-converter.es5.js
  ...
  var nepali_date_converter_es5_default = NepaliDate;

  // ../nepali_calendar/nepali_calendar/public/js/custom_control_date.js
  ...
  frappe.ui.form.ControlDate = class CustomControlDate extends frappe.ui.form.ControlDate {
    ...
    npmake_picker() {
      ...
      var self2 = this;
      $(this.$npInput).on("dateSelect", function(event2) {
        var datePickerData = event2.datePickerData;
        ...
        self2.$input.val(formattedDate);
        self2.$input.trigger("change");
      });
      $(this.$npInput).removeAttr("readonly");
      this.$input.after(this.$npInput);
    }
    _toggleDatepicker() {
      if (!this.$npInput || !this.$npInput.length) {
        return;
      }
